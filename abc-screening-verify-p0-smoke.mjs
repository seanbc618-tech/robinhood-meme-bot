...
const dual=dualTop10Concentration({
  top10_raw_total_supply_bps:4000,top10_ex_lp_circulating_bps:2000,top10_circulating_bps:2000,
  lp_exclusion:{status:'OBSERVED',excluded_count:1,addresses:['0x1']},
});
assert('dual raw+ex_lp',dual.top10_raw.value_bps===4000&&dual.top10_ex_lp.value_bps===2000&&dual.gate_unchanged);
